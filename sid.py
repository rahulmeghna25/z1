...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7646443370:AAGo_IObCTPq075QWSFffeeqFknOh2-NNos'  # Replace with your bot token
OWNER_USERNAME = "Gaarjalegi_sabki"  # Replace with your Telegram username (without @)
DEFAULT_GROUP_ID = -1002554775324  # Default group ID
...
async def start(update: Update, context: CallbackContext):
    ...
    # If the user starts the bot in an allowed group
...
async def attack_start(update: Update, context: CallbackContext):
    ...
    # If the user tries to use the attack command outside an allowed group
    if not is_allowed_group(update):
...
async def rules(update: Update, context: CallbackContext):
    rules_text = (
        ...
        "5. Any violation of these rules will result in a ban.\n\n\n"
